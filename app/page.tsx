...
import { getStreakStats, markTodayAsStudied, getTodayString, getStudyDates, seedDemoHistory } from '@/lib/streakLogic';
...
export default function Dashboard() {
  ...
  useEffect(() => {
    setMounted(true);
    seedDemoHistory(); // Seed demo data on first visit
    loadStats();
  }, [loadStats]);
